...
load data local inpath './processed_data/GEO-100-100.txt' overwrite into table geo;
...
load data local inpath './processed_data/GeneMetaData-100-100.txt' overwrite into table genes;
...
load data local inpath './processed_data/PatientMetaData-100-100.txt' overwrite into table patients;
