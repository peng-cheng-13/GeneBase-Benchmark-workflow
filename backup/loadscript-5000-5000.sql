...
load data local inpath './processed_data/GEO-5000-5000.txt' overwrite into table geo;
...
load data local inpath './processed_data/GeneMetaData-5000-5000.txt' overwrite into table genes;
...
load data local inpath './processed_data/PatientMetaData-5000-5000.txt' overwrite into table patients;
